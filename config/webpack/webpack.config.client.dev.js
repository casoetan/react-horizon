...
const devConfig = _.assign(_.clone(defaultConfig), {
  ...
  output: _.assign(_.cloneDeep(defaultConfig.output), {
    publicPath: `https://127.0.0.1:${devProps.webpackPort}/static/`,
    pathinfo: true,
...
localCssConfig.loader = ExtractTextPlugin.extract(
  'style',
  'css?sourceMap&modules&importLoaders=1&localIdentName=react_horizon_[local]_[hash:base64:5]!postcss'
);
